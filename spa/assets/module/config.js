...
layui.define(function (exports) {
    var config = {
        ...
        base_server: 'http://demo.top/api/v1', // 接口地址，实际项目请换成http形式的地址，这里localhost那么浏览器访问也要是localhost，用127.0.0.1就拿不到session。
        ...
        token:function () {
            ...
            return 'USERID ' + config.Base64(token.client.appid+':'+token.access_token+':'+token.client.uid);
